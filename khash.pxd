from numpy cimport int64_t, int32_t, uint32_t, float32_t
...
cdef extern from "khash.h":
    ...
    ctypedef struct kh_int64_weighted_t:
        khint_t n_buckets, size, n_occupied, upper_bound
        uint32_t *flags
        int64_t *keys
        float32_t *vals
    ...
    inline kh_int64_weighted_t* kh_init_int64_weighted()
    inline void kh_destroy_int64_weighted(kh_int64_weighted_t*)
    inline void kh_clear_int64_weighted(kh_int64_weighted_t*)
    inline khint_t kh_get_int64_weighted(kh_int64_weighted_t*, int64_t)
    inline void kh_resize_int64_weighted(kh_int64_weighted_t*, khint_t)
    inline khint_t kh_put_int64_weighted(kh_int64_weighted_t*, int64_t, int*)
    inline void kh_del_int64_weighted(kh_int64_t*, khint_t)
    bint kh_exist_int64_weighted(kh_int64_weighted_t*, khiter_t)
